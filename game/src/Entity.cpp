...
Entity::Entity(uint32_t id, uint8_t type, std::string name, _movement::Movement movement, _interaction::Interaction interaction) {
    this->id_ = id;
    this->type_ = type;
    this->name_ = name;
...
void Entity::setInteraction(_interaction::Interaction interaction) { this->interaction_ = interaction; }
...
_interaction::Interaction Entity::getInteraction() { return interaction_; }
