...
NPC::NPC(uint32_t id, uint8_t type, std::string name, _movement::Movement movement, _interaction::Interaction interaction, std::vector<std::string> dialogue, std::vector<utils::Coordinate> boundaries,
